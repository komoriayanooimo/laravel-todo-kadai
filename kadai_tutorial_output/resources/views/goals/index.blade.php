...
@section('content')
    <div class="container h-100"> 
        ...
        <div class="d-flex mb-3">
            <!-- data-bs-toggle属性やdata-bs-target属性はBootstrapでモーダルなどを実装するときのお作法 属性に"modal"を指定 -->
            <!-- "#addGoalModal"と指定すれば、そのリンクをクリックしたときにaddGoalModalというidを持つモーダルが呼び出される -->
        ...
        <!-- $goals Goalコントローラのindexアクションから渡された「現在ログイン中のユーザーが持つすべての目標」-->                 
